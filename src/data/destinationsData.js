    ...
    places: [
      ...
      },
      {
        ...
        attractions: [
          ...
          { id: 'penang-hill', name: 'Penang Hill (Bukit Bendera) & Habitat Canopy', category: 'Panoramic Viewpoints', rating: 4.7, reviewsCount: 51200, priceEstimate: 'RM 30 (Funicular)', estimatedHours: '3 hours', address: 'Bukit Bendera, Ayer Itam', lat: 5.4085, lng: 100.2770, image: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=800&q=80', description: 'Cool mountain breeze, historic funicular train, and Curtis Crest Tree Top Walk.' },
          { id: 'penang-blue-mansion', name: 'Cheong Fatt Tze - The Blue Mansion', category: 'Heritage & Architecture', rating: 4.7, reviewsCount: 18400, priceEstimate: 'RM 25', estimatedHours: '1.5 hours', address: '14, Leith St, George Town', lat: 5.4216, lng: 100.3347, image: 'https://images.unsplash.com/photo-1563911302283-d2bc129e7570?auto=format&fit=crop&w=800&q=80', description: '19th-century indigo-blue courtyard mansion with traditional feng shui courtyards.' },
          { id: 'penang-chew-jetty', name: 'Clan Jetties of Penang (Chew Jetty)', category: 'Heritage Wooden Stilt Village', rating: 4.6, reviewsCount: 29500, priceEstimate: 'Free', estimatedHours: '1 hour', address: 'Weld Quay, George Town', lat: 5.4124, lng: 100.3398, image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80', description: '19th-century Chinese waterfront wooden stilt settlements over the sea.' }
        ],
        restaurants: [
          { id: 'penang-siam-road', name: 'Siam Road Charcoal Char Kway Teow', cuisine: 'Michelin Bib Gourmand Char Kway Teow', priceTier: '$', priceRange: 'RM 8 - RM 15', rating: 4.8, reviewsCount: 8200, mealType: 'Lunch', address: '82, Jalan Siam, George Town', lat: 5.4150, lng: 100.3200, image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=800&q=80', description: 'Wok-hei infused charcoal fried flat noodles with duck egg, cockles and fresh prawns.' },
          { id: 'penang-gurney', name: 'Gurney Drive Night Hawker Food Market', cuisine: 'Penang Street Food & Lok Lok', priceTier: '$', priceRange: 'RM 15 - RM 35', rating: 4.7, reviewsCount: 14600, mealType: 'Dinner', address: 'Persiaran Gurney, George Town', lat: 5.4398, lng: 100.3090, image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80', description: 'Famous seaside night food haven for Assam Laksa, Rojak, and Oyster Omelette.' },
          { id: 'penang-line-clear', name: 'Restoran Line Clear Nasi Kandar', cuisine: 'Legendary 24h Nasi Kandar', priceTier: '$', priceRange: 'RM 12 - RM 28', rating: 4.6, reviewsCount: 16900, mealType: 'Lunch / Dinner', address: '177, Jalan Penang, George Town', lat: 5.4172, lng: 100.3325, image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=800&q=80', description: 'Iconic alleyway spot famed for giant spiced fried chicken and mixed curry gravies.' }
        ]
      },
      {
        id: 'langkawi',
